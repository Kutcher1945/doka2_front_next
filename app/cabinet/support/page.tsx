...
const FAQ = [
  {
    q: 'Как начать играть?',
    a: 'Зарегистрируйтесь, пополните баланс, подключите Steam аккаунт в настройках профиля, затем найдите или создайте лобби.',
  },
  {
    q: 'Как работает вывод средств?',
    a: 'После победы средства зачисляются на баланс. Вы можете вывести их через раздел «Кошелёк» → «Вывести», выбрав удобный способ.',
  },
  {
